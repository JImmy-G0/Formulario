...
Paginas e arquivos de cada pagina:
Pagina de Login: Pagina inicial de login, com campos de email e senha necessarios para entrar com uma conta na pagina principal. 
...
Pagina de cadastro: Pagina para o cadastro de usuarios, onde se cadastra o email e senha necessarios para entrar na pagina principal pela pagina do login.
...
Pagina do painel: Pagina onde é exibido em formato de graficos e cards as informações gerais dos alunos cadastrados na pagina de cadastro de alunos.
